...
export const bogoSortInfo: AlgorithmInfo = {
  name: 'Bogo Sort',
  description: 'Bogo Sort (also called permutation sort or stupid sort) repeatedly shuffles the elements until the array is sorted. It is primarily useful as an educational example of an extremely inefficient algorithm.',
  complexity: {
  ...
  advantages: ['Very simple to implement', 'Useful as a teaching example to contrast with efficient algorithms'],
  disadvantages: ['Extremely inefficient', 'Not suitable for any practical use'],
  useCases: ['Educational demonstrations', 'Humorous examples'],
  keyCharacteristics: ['Randomized algorithm', 'Relies on permutations/shuffles', 'Factorial expected time'],
  visualizationNotes: {
